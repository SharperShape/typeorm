...
class BaseEntity {
     ...
     */
    static findOne(...args) {
        return this.getRepository().findOne(...args);
    }
    /**
     * Finds first entity that matches given conditions.
     */
     ...
     */
    static observe(optionsOrConditions) {
     ...
     * Whenever new data appears that matches given query observable emits new value.
     */
    static observeManyAndCount(optionsOrConditions) {
     ...
     * Whenever new data appears that matches given query observable emits new value.
     */
    static observeOne(optionsOrConditions) {
     ...
     * Whenever new data appears that matches given query observable emits new value.
     */
    static observeCount(optionsOrConditions) {
