...
exports.createLiteralMongoRepository = void 0;
const LiteralRepository_1 = require("./LiteralRepository");
/**
 * Repository is supposed to work with your entity objects. Find entities, insert, update, delete, etc.
 */
function createLiteralMongoRepository({ manager, target, queryRunner }) {
    return Object.assign(Object.assign({}, LiteralRepository_1.createLiteralRepository({ manager, target, queryRunner })), { typeof: "MongoRepository", manager: manager, query(query, parameters) {
