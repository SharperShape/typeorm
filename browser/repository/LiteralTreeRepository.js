 ...
 */
export function createLiteralTreeRepository({ manager, target, queryRunner }) {
    ...
    // -------------------------------------------------------------------------
    return Object.assign(Object.assign({}, createLiteralRepository({ manager, target, queryRunner })), { typeof: "TreeRepository", async findTrees() {
