 ...
 */
export declare type QueryFindOptions<E> = Pick<FindOptions<E>, "select"> & Pick<FindOptions<E>, "where"> & Pick<FindOptions<E>, "order"> & Pick<FindOptions<E>, "relations"> & Pick<FindOptions<E>, "skip"> & Pick<FindOptions<E>, "take"> & Pick<FindExtraOptions, "loadRelationIds"> & Pick<FindExtraOptions, "pagination"> & Pick<FindExtraOptions, "withDeleted">;
