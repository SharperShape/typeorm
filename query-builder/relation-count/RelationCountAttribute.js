...
class RelationCountAttribute {
    ...
    get junctionAlias() {
        const [parentAlias, relationProperty] = QueryBuilderUtils_1.QueryBuilderUtils.extractAliasAndPropertyPath(this.relationName);
    ...
    get relation() {
        if (!QueryBuilderUtils_1.QueryBuilderUtils.isAliasProperty(this.relationName))
            throw new Error(`Given value is a string representation of alias property`);
        const [parentAlias, propertyPath] = QueryBuilderUtils_1.QueryBuilderUtils.extractAliasAndPropertyPath(this.relationName);
