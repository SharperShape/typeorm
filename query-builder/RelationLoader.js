...
class RelationLoader {
     ...
     */
    enableLazyLoad(relation, entity, queryRunner, queryBuilder) {
        ...
        Object.defineProperty(entity, relation.propertyName, {
            get: function () {
                ...
                const loader = relationLoader.load(relation, this, queryRunner, queryBuilder).then(result => relation.isOneToOne || relation.isManyToOne ? result[0] : result);
